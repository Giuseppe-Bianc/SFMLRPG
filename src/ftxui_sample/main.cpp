...
// configuration step. It creates a namespace called `SFMLRPG`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", SFMLRPG::cmake::project_name, SFMLRPG::cmake::project_version) };
